# Override the whole BigDecimal from stdlib with BigDecimal from crystal master
# https://github.com/crystal-lang/crystal/blob/master/src/big/big_decimal.cr
...
struct BigDecimal < Number
  ...
  # **Minimal edit here, since we're not running crystal master but taking this file from master**
