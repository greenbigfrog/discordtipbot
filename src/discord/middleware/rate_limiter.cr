...
class MW::RateLimiter
  ...
  private def reply(client, channel_id)
    client.create_message(channel_id, "This command has been ratelimited. Please wait before trying again.") # You can get rid of this by getting premium. Visit #{TB::SUPPORT} for more info.
  end
